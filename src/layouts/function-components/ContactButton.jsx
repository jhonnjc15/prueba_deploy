    ...
    return (
        <div className='group fixed z-90 bottom-10 right-8 w-16 h-16 hover:h-48'>
            <div className='hidden group-hover:flex group-hover:flex-col h-32 justify-center items-center gap-4'>
                <button href={whatsappMessage} target="_blank" className='group-hover:animate-[comein_0.3s_ease-in-out_forwards] hover:drop-shadow-2xl'>
                    <svg
                ...
                <button href={telegramMessage} target="_blank" className='group-hover:animate-[comein_0.6s_ease-in-out_forwards] hover:drop-shadow-2xl'>
                    <svg
